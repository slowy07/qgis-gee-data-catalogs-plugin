...
- Root folder renamed from 'gee_data_catalogs' to the target plugin name
...
Examples:
    ...
    python package_plugin.py --name gee_data_catalogs
"""
...
def package_plugin(
    ...
    target_name: str = "gee_data_catalogs",
    ...
    Args:
        source_dir: Path to the gee_data_catalogs directory
        output_path: Optional path for the output zip file
        target_name: Name for the root folder in the zip (default: 'gee_data_catalogs')
...
def main():
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="Output path for the zip file (default: gee_data_catalogs-{version}.zip in the same folder as this script)",
    )
    parser.add_argument(
        "--source",
        "-s",
        type=Path,
        default=None,
        help="Source directory (default: gee_data_catalogs in the same folder as this script)",
    )
    parser.add_argument(
        "--name",
        "-n",
        ...
        help="Target plugin name for the zip root folder (default: gee_data_catalogs)",
    )
    parser.add_argument(
        "--no-version",
        action="store_true",
    ...
    source_dir = args.source if args.source else script_dir / "gee_data_catalogs"
